...
sudo easyrsa --passin=file:capassfile --passout=file:cppassfile  build-client-full $clientname 
sudo easyrsa --passin=file:cppassfile --passout=file:p12passfile export-p12 $clientname
